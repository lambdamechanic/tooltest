...
- Add a gated stdio integration test that exercises the Smithery playground server via `npx @smithery/cli@latest playground @executeautomation/playwright-mcp-server`.
