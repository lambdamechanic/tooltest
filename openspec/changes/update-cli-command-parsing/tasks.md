...
- [x] 1.4 Add a gated stdio integration test that runs the Smithery playground server via `npx @smithery/cli@latest playground @executeautomation/playwright-mcp-server`.
